...
describe('MapListComponent', () => {
    ...
    it('should display the details of each game', () => {
        ...
        expect(item.nativeElement.textContent).toContain(mockBoardGames[0].status);
    });

    it('should allow toggling the visibility of the game', () => {
        const mockMap = mockBoardGames[0];
        mockBoardService.toggleVisibility.and.returnValue(of({ ...mockMap, visibility: 'Private' }));
