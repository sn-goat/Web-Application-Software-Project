...
describe('GamePageComponent', () => {
    ...
    const onGameEndedSubject = new BehaviorSubject<IPlayer>({} as IPlayer);
    ...
    const socketServiceMock = {
        ...
        onGameEnded: jasmine.createSpy('onGameEnded').and.returnValue(onGameEndedSubject),
    ...
    it('should display the correct message and navigate after game ends with team winner', fakeAsync(() => {
        ...
        onGameEndedSubject.next(winner);
